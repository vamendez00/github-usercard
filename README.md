**UNIT 2.1.4 MODULE PROJECT - GITHUB USER CARDS**

**PROJECT OBJECTIVE**
The CSS and the base HTML is already done.

The project's main objective is to create a component based on:
a)data request from an API that
b)iterates over that data, and then
c)displays that data in the form of a user profile card.
...
**INITIAL SETUP - Follow these steps**
...
**COMMAND TERMINAL SETUP AND STEPS TO SUBMIT**
...
- [x] Copy pull request link and submit in Canvas.

---

**VS CODE TERMINAL SETUP**

- [x] Always make sure you are navigated to the root of the project.
...
#### Option 2 (installing Axios with npm - USE NEW TERMINAL)
